...
return array(
	...
	'error_company_name_import_file'         => 'A company name from the file does not exist',
	'error_company_id_import_file'           => 'Found a duplicate id in the file, the duplicated id is the number',
	'error_missing_headers_import_file'		 => 'The file must contains in the top row the data headers',
